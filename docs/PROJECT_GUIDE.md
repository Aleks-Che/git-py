...
файлов. Используются текущие URL, ключ, модель, timeout и max_diff_chars.
...
неполный JSON, повторные/неизвестные ID, маркеры конфликта и превышение лимита
отклоняются. Запрос работает через LatestWorker, с индикацией, блокировкой
